 ...
 */
class SupadataLoader extends base_1.BaseDocumentLoader {
    constructor(params) {
        super();
    ...
    resolveApiKey() {
        ...
        const envKey = (0, env_1.getEnvironmentVariable)("SUPADATA_API_KEY");
        if (!envKey) {
    ...
    getClient() {
        ...
        return new js_1.Supadata({ apiKey });
    }
...
exports.SupadataLoader = SupadataLoader;

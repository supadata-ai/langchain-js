...
type MetadataPlatform = 'youtube' | 'tiktok' | 'instagram' | 'twitter';
type MetadataType = 'video' | 'image' | 'carousel' | 'post';
...
type Media = VideoMedia | ImageMedia | CarouselMedia | PostMedia;
interface Metadata {
...
declare class Supadata extends BaseClient {
